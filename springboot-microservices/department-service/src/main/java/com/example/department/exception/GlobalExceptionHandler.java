...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleValidationExceptions(MethodArgumentNotValidException ex, HttpServletRequest request) {
        logger.warn("Validation error in department service: {}", ex.getMessage());
        ...
        problemDetail.setProperty("service", "department-service");
    ...
    public ProblemDetail handleResourceNotFound(ResourceNotFoundException ex, HttpServletRequest request) {
        logger.warn("Resource not found in department service: {}", ex.getMessage());
    ...
    public ProblemDetail handleDuplicateResource(DuplicateResourceException ex, HttpServletRequest request) {
        logger.warn("Duplicate resource in department service: {}", ex.getMessage());
    ...
    public ProblemDetail handleExternalServiceError(ExternalServiceException ex, HttpServletRequest request) {
        logger.error("External service error in department service: {}", ex.getMessage(), ex);
    ...
    public ProblemDetail handleBusinessRule(BusinessException ex, HttpServletRequest request) {
        logger.warn("Business rule violation in department service: {}", ex.getMessage());
    ...
    public ProblemDetail handleIllegalArgument(IllegalArgumentException ex, HttpServletRequest request) {
        logger.warn("Illegal argument in department service: {}", ex.getMessage());
    ...
    public ProblemDetail handleGenericException(Exception ex, HttpServletRequest request) {
        logger.error("Unexpected error in department service: {}", ex.getMessage(), ex);
